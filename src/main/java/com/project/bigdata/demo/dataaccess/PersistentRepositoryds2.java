...
@Component
public class PersistentRepositoryds2 implements Serializable {
    ...
    @Autowired
    public PersistentRepositoryds2(ApplicationConfig applicationConfig){

        this.applicationConfig = applicationConfig;
        this.connection = ConnectionUtils.connection();
        String path = applicationConfig.getDbStoragePathds2();
    ...
    public void insert(String[] data) {
        ...
        for (String item : data) {
            ...
            String id = doc.getString(applicationConfig.getIdentityFieldNameds2());
            doc.setId(id);
            store.insert(doc);
        }
        store.flush();
    ...
    public void insert(String data) {
        if (data != null  && !data.isEmpty()) {
            ...
            String id_1 = object.get(applicationConfig.getTableIdentityFieldNameds2()).toString();
            String id_2 = object.get(applicationConfig.getIdentityFieldNameds2()).toString();
