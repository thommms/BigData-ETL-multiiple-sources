...
@Component
public class PersistentRepositoryds3 implements Serializable {
    ...
    @Autowired
    public PersistentRepositoryds3(ApplicationConfig applicationConfig){

        this.applicationConfig = applicationConfig;
        this.connection = ConnectionUtils.connection();
        String path = applicationConfig.getDbStoragePathds3();
    ...
    public void insert(String[] data) {
        ...
        for (String item : data) {
            ...
            String id = doc.getString(applicationConfig.getIdentityFieldNameds3());
            doc.setId(id);
            store.insert(doc);
        }
        store.flush();
    ...
    public void insert(String data) {
        if (data != null  && !data.isEmpty()) {
            ...
            String id_1 = object.get(applicationConfig.getTableIdentityFieldNameds3()).toString();
            String id_2 = object.get(applicationConfig.getIdentityFieldNameds3()).toString();
