...
import com.interswitch.bigdata.demo.utils.Utilitiesds3;
...
@Component
public class SQLServerDataProviderds3 {
    ...
    String getSqlQuery(long lowerBound, long upperBound){
        String tableName = applicationConfig.getJdbcTableNameds3();
        String identityTableName = applicationConfig.getIdentityFieldNameds3();
    ...
    String getLookAheadQuery(long lowerBound){
        String tableName = applicationConfig.getJdbcTableNameds3();
        String identityFieldName = applicationConfig.getIdentityFieldNameds3();
    ...
    public List<Map<String, Object>> query(long lastCheckpoint) {
        ...
        List<Map<String, Object>> result = applicationConfig.ds3Template().queryForList(getSqlQuery(lastCheckpoint,newCheckpoint));
    ...
    public long recordExists(long lastCheckPoint) throws Exception{
        ...
        nextPostTranId = applicationConfig.ds3Template().queryForObject(recordExistsQuery, new RowMapper<Long>() {
            @Nullable
            @Override
            public Long mapRow(ResultSet resultSet, int i) throws SQLException {
                Long nextPostTranId = resultSet.getLong(applicationConfig.getIdentityFieldNameds3());
