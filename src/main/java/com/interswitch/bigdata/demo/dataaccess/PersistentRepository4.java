...
@Component
@Singleton
public class PersistentRepository4 implements Serializable {
    ApplicationConfig applicationConfig;
    Connection connection;
    DocumentStore store;

    @Autowired
    public PersistentRepository4(ApplicationConfig applicationConfig){

        this.applicationConfig = applicationConfig;
        this.connection = ConnectionUtils.connection();
        String path = applicationConfig.getDbStoragePathds4();
    ...
    public void insert(String[] data) {
        ...
        for (String item : data) {
            ...
            String id = doc.getString(applicationConfig.getIdentityFieldNameds4());
            doc.setId(id);
            store.insert(doc);
        }
        store.flush();
    ...
    public void insert(String data) {
        if (data != null  && !data.isEmpty()) {
            ...
            String id_1 = object.get(applicationConfig.getTableIdentityFieldNameds4()).toString();
            String id_2 = object.get(applicationConfig.getIdentityFieldNameds4()).toString();
